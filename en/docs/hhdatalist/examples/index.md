...
<script>
  ...
  function reportError(error) {
    showToast(`error`, `Error`, `${error.response.data.detail} <a href='${errorPage}/#${error.response.data.type}' target='_blank'>Details</a>.`
    );
  }
...
This page provides several examples that demonstrate HHDataList features.
