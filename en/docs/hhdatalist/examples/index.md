...
This page shows various ways to use the HHDataList UI component on a webpage.
...
<script>
  new HHDataList({
    ...
    reportError: (error) => {
      showToast(`error`, error.response.data.title, `${error.response.data.detail} <a href='http://localhost:8080/en/docs/hhrestapi/problems/#${error.response.data.type}' target='_blank'>Click for details</a>`);
    },
    reportInfo: (msg) => { 
