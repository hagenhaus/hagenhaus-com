...
``` nonum
<a href="http://localhost:8081/api/famous/v1/trees">http://localhost:8081/api/famous/v1/trees</a>
<a href="http://localhost:8081/api/famous/v1/trees/1">http://localhost:8081/api/famous/v1/trees/1</a>
```
...
``` nonum
<a href="http://localhost:8081/api/famous/v1/trees?fields=id%2Cname">http://localhost:8081/api/famous/v1/trees?fields=id%2Cname</a>
<a href="http://localhost:8081/api/famous/v1/trees?filter=country%20like%20%22AUS%22">http://localhost:8081/api/famous/v1/trees?filter=country%20like%20%22AUS%22</a>
<a href="http://localhost:8081/api/famous/v1/trees?order=name%20asc">http://localhost:8081/api/famous/v1/trees?order=name%20asc</a>
<a href="http://localhost:8081/api/famous/v1/trees?page=1&limit=3">http://localhost:8081/api/famous/v1/trees?page=1&limit=3</a>
```
...
``` nonum
<a href="http://localhost:8081/api/famous/v1/trees/1?fields=name%2Cspecies%2Cdescription%2Ccity%2Ccountry%2Clat%2Clng%2CbirthYear%2Cheight%2Clinks%2Cid">http://localhost:8081/api/famous/v1/trees/1?fields=name%2Cspecies%2Cdescription%2Ccity%2Ccountry%2Clat%2Clng%2CbirthYear%2Cheight%2Clinks%2Cid</a>
```
...
1. Check the checkbox beside the Requests Reporter label to display the tool. By default, this tool calls `console.log` to output requests to the Developer Tools console of your browser. Here is example output:
    ...
    ``` nonum
    GET: http://localhost:8081/api/famous/v1/trees/1
    ```
...
1. Display your browser console, expand a few records, and notice the output in the browser console.
    ...
    ``` nonum
    GET: http://localhost:8081/api/famous/v1/trees/1
    GET: http://localhost:8081/api/famous/v1/trees/4
    GET: http://localhost:8081/api/famous/v1/trees/5
    GET: http://localhost:8081/api/famous/v1/trees/8
    ```
...
1. Inspect API requests. Notice the `limit` query parameter. Here is an example:
    ...
    ``` nonum
    GET http://localhost:8081/api/famous/v1/trees?limit=5
    ```
...
1. Inspect API requests. Notice the `page` query parameter. Here is an example:
    ...
    ``` nonum
    GET http://localhost:8081/api/famous/v1/trees?page=2&limit=3
    ```
...
1. Scroll expanded records and examine the Request URLs. Example:
    ...
    GET: http://localhost:8081/api/famous/v1/trees/4
    GET: http://localhost:8081/api/famous/v1/trees/5
    GET: http://localhost:8081/api/famous/v1/trees/6
    ```
...
1. Scroll expanded records again and examine the request URLs. Example:
    ...
    ``` nonum
    http://localhost:8081/api/famous/v1/trees?page=2&limit=3
    ```
...
1. Scroll and inspect API requests. Notice the `fields` query parameter. Here is an example:
    ...
    ``` nonum
    GET: http://localhost:8081/api/famous/v1/trees?fields=id%2Cname&page=2&limit=3
    ```

1. In `manage` process mode, expand a record. Here is example output:

   ``` nonum
    GET: http://localhost:8081/api/famous/v1/trees/4?fields=name%2Cspecies%2Cdescription%2Ccity%2Ccountry%2Clat%2Clng%2CbirthYear%2Cheight%2Clinks%2Cid
    ```
...
1. Notice the `filter` query parameter in request URLs. Example:
    ...
    ``` nonum
    GET: http://localhost:8081/api/famous/v1/trees?fields=id%2Cname&filter=country%20like%20%22AUS%22&page=1&limit=3
    ```
